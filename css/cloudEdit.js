...
(function cloudEdit() {
  ...
  (function initAce() {
    ...
    (function sessionStorageGet() {
      if (sessionStorage.getItem("html")) {
        ...
        htmlField.setValue("Happy Code Longer");
        htmlField.clearSelection();
  ...
  function buildOutput(consoleJS) {
    ...
    html +='<link rel="stylesheet" type="text/css" href="include/Jquery/jquery-ui.css">\n';
    html +='<script type="text/javascript" src="include/Jquery/external/jquery/jquery.js"></script>\n';
    html +='<script type="text/javascript" src="include/Jquery/jquery-ui.js"></script>\n';
    if (use.Normalize) {
      html += '<link href="include/Normalized/Normalize.css" rel="stylesheet">\n';
    ...
    if (use.Bootstrap) {
      html += '<link href="include/Bootstrap/css/bootstrap.min.css" rel="stylesheet">\n';
      html += '<link href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.1.1/css/bootstrap.min.css" rel="stylesheet">\n';
    }
    if (use.Metro_ui) {
      html += '<link href="include/metro/css/metro.css" rel="stylesheet">\n';
      html += '<link href="include/metro/css/metro-icons.css" rel="stylesheet">\n';
      html += '<link href="include/metro/css/docs.css" rel="stylesheet">\n';
      html += '<script src="include/jquery/jquery-2.1.3.min.js"></script>\n';
      html += '<script src="include/metro/js/metro.js"></script>\n';
    }
    if (use.Foundation) {
      html += '<link href="include/Foundation/css/foundation.min.css" rel="stylesheet">\n';
    ...
    html += '\n</style>\n';
    if (use.Modernizr) {
      html += '<script src="include/Modernizer/modernizer.js"></script>\n';
    ...
    if (use.Bootstrap) {
      ...
      html += '<script src="include/Bootstrap/js/bootstrap.min.js"></script>\n';
    }
    if (use.Foundation) {
      html += '<script src="include/Foundation/js/foundation.min.js"></script>\n';
